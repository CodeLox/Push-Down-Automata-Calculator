...
def equalpress():
    ...
    if(len(User_input) != 0):
        try:
            ...
            while New_Stack.check():  # copy one stack to another because of order
                temp = New_Stack.pop()
                Mystack.push(temp)
            ...
            while 1:
                ...
                if state == 0 and Mystack.peek() == '(':
                    ...
                    if automated_stack.peek() == '$' and Mystack.peek() == '$':
                        temp_validity = "Valid"
                        break
                elif state == 0 and Mystack.peek() == ')' or Mystack.peek() == '+' or Mystack.peek() == '-' or Mystack.peek() == '*' or Mystack.peek() == '/':
                    vall = Mystack.pop()
                    if Mystack.peek() == '$'or Mystack.peek() == ')' or Mystack.peek() == '+' or Mystack.peek() == '-' or Mystack.peek() == '*' or Mystack.peek() == '/':
                        temp_validity = "Invalid"
                        break
                else:
                    temp_validity = "Invalid"
...
if __name__ == "__main__":
    ...
    Validity_field.grid(columnspan=5, ipadx=100)
    User_input_field.grid(columnspan=5, ipadx=100)
    ...
    button1 = Button(gui, text=' 1 ', fg='white', bg='#505050',
                     command=lambda: press(1), height=2, width=10)
    button1.grid(row=2, column=0)

    button2 = Button(gui, text=' 2 ', fg='white', bg='#505050',
                     command=lambda: press(2), height=2, width=10)
    button2.grid(row=2, column=1)

    button3 = Button(gui, text=' 3 ', fg='white', bg='#505050',
                     command=lambda: press(3), height=2, width=10)
    button3.grid(row=2, column=2)

    button4 = Button(gui, text=' 4 ', fg='white', bg='#505050',
                     command=lambda: press(4), height=2, width=10)
    button4.grid(row=3, column=0)

    button5 = Button(gui, text=' 5 ', fg='white', bg='#505050',
                     command=lambda: press(5), height=2, width=10)
    button5.grid(row=3, column=1)

    button6 = Button(gui, text=' 6 ', fg='white', bg='#505050',
                     command=lambda: press(6), height=2, width=10)
    button6.grid(row=3, column=2)

    button9 = Button(gui, text=' 9 ', fg='white', bg='#505050',
                     command=lambda: press(9), height=2, width=10)
    button9.grid(row=4, column=0)

    button8 = Button(gui, text=' 8 ', fg='white', bg='#505050',
    ...
    button0 = Button(gui, text=' 0 ', fg='white', bg='#505050',
                     command=lambda: press(0), height=2, width=10)
    button0.grid(row=5, column=0)

    plus = Button(gui, text=' + ', fg='white', bg='#FF9500',
                  command=lambda: press("+"), height=2, width=10)
    plus.grid(row=2, column=3)

    minus = Button(gui, text=' - ', fg='white', bg='#FF9500',
                   command=lambda: press("-"), height=2, width=10)
    minus.grid(row=3, column=3)

    multiply = Button(gui, text=' x ', fg='white', bg='#FF9500',
                      command=lambda: press("*"), height=2, width=10)
    multiply.grid(row=4, column=3)

    divide = Button(gui, text=' / ', fg='white', bg='#FF9500',
                    command=lambda: press("/"), height=2, width=10)
    divide.grid(row=5, column=3)

    bracketstart = Button(gui, text=' ( ', fg='white', bg='#FF9500',
                          command=lambda: press("("), height=2, width=10)
    bracketstart.grid(row=5, column=1)

    bracketend = Button(gui, text=' ) ', fg='white', bg='#FF9500',
                        command=lambda: press(")"), height=2, width=10)
    bracketend.grid(row=5, column=2)

    equal = Button(gui, text=' = ', fg='white', bg='#FF9500',
                   command=equalpress, height=2, width=10)
    equal.grid(row=6, column=3)

    clear = Button(gui, text='Clear', fg='black', bg='#D4D4D2',
                   command=clear, height=2, width=10)
    clear.grid(row=6, column=0)

    filler1 = Button(gui, text='', fg='black', bg='#D4D4D2',
                   command='', height=2, width=10)
    filler1.grid(row=6, column=1)

    filler2 = Button(gui, text='', fg='black', bg='#D4D4D2',
                   command='', height=2, width=10)
